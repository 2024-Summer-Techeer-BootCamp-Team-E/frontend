...
export default function ALiProducts() {
  ...
  return (
    <div className="flex flex-col gap-4 my-3 text-xs font-semibold w-60">
      ...
      <p>UV 차단 미니 접이식 파라솔</p>
      <p className="text-black/50">Delivery : ₩ 2500</p>
      <p className="text-orange">₩ 1000</p>
    </div>
  )
}
