...
const OriginBtn = ({ children, link }: BtnProps) => {
  ...
  return (
    <a
      className="relative flex items-center px-4 py-1 pl-2 overflow-hidden font-medium border-2 rounded-full sm:px-5 sm:pl-3 md:pl-6 md:px-10 text-hongsi border-hongsi hover:text-white group hover:bg-gray-50 whitespace-nowrap"
      onClick={handleClick}
    >
